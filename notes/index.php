...
<style>
.notes-hero{ position:relative; padding:2.5rem; border-radius:1.75rem; background:linear-gradient(135deg,#eef2ff,#e0f2fe); box-shadow:0 24px 45px rgba(15,23,42,.12); display:grid; gap:2rem; }
.notes-hero__headline{ display:flex; justify-content:space-between; gap:2rem; flex-wrap:wrap; align-items:flex-start; }
.notes-hero__eyebrow{ font-size:.75rem; text-transform:uppercase; letter-spacing:.12em; color:#4338ca; margin:0 0 .5rem; }
.notes-hero__subtitle{ margin:0; max-width:38rem; color:#1e293b; line-height:1.5; }
.notes-hero__actions{ display:flex; gap:.75rem; flex-wrap:wrap; }
.notes-hero__meta{ display:flex; align-items:flex-end; }
.notes-hero__stamp{ background:rgba(255,255,255,.78); border-radius:1rem; padding:1rem 1.5rem; box-shadow:0 18px 38px rgba(15,23,42,.15); display:flex; flex-direction:column; gap:.25rem; }
...
.notes-hero__metrics{ display:grid; gap:1rem; grid-template-columns:repeat(auto-fit,minmax(160px,1fr)); }
.notes-metric{ background:rgba(255,255,255,.82); border-radius:1.25rem; padding:1.25rem; box-shadow:0 20px 34px rgba(15,23,42,.12); display:flex; flex-direction:column; gap:.45rem; }
.notes-metric__label{ font-size:.8rem; text-transform:uppercase; letter-spacing:.08em; color:#475569; }
.notes-metric__value{ font-size:1.9rem; font-weight:600; color:#0f172a; }
.notes-metric__hint{ font-size:.9rem; color:#64748b; margin:0; }

.notes-controls{ margin-top:1.5rem; display:flex; flex-direction:column; gap:1.5rem; }
...
.notes-field input, .notes-field select{ border:1px solid #cbd5f5; border-radius:.85rem; padding:.65rem .85rem; font-size:1rem; background:#fff; }
...
.chip{ border:1px solid rgba(99,102,241,.3); background:rgba(99,102,241,.08); color:#312e81; border-radius:999px; padding:.45rem 1rem; font-size:.85rem; cursor:pointer; transition:all .2s ease; }
.chip.is-active, .chip[aria-pressed="true"]{ background:#6366f1; color:#fff; border-color:#6366f1; box-shadow:0 12px 24px rgba(99,102,241,.35); }
.notes-view-toggle{ display:flex; gap:.5rem; border:1px solid rgba(148,163,184,.4); border-radius:999px; padding:.25rem; background:rgba(255,255,255,.75); }
...
.note-board{ display:grid; gap:1.25rem; grid-template-columns:repeat(auto-fit,minmax(280px,1fr)); }
.note-board__column{ display:grid; gap:.75rem; background:rgba(248,250,252,.8); border-radius:1.25rem; padding:1rem; border:1px solid rgba(148,163,184,.25); }
...
.note-board__list{ display:grid; gap:.75rem; }
.note-board__empty{ margin:0; font-size:.9rem; }

.note-card{ background:#fff; border-radius:1.1rem; border:1px solid rgba(148,163,184,.25); padding:1rem 1.1rem; box-shadow:0 18px 36px rgba(15,23,42,.08); display:grid; gap:.85rem; }
.note-card__header{ display:flex; gap:.85rem; align-items:center; }
.note-card__icon{ width:42px; height:42px; border-radius:14px; background:#eef2ff; display:grid; place-items:center; font-size:1.25rem; }
...
.notes-table__title-main{ display:flex; gap:.65rem; align-items:flex-start; }
.notes-table__icon{ width:40px; height:40px; border-radius:12px; background:#eef2ff; display:grid; place-items:center; font-size:1.1rem; }
...
.notes-row{ transition:background .2s ease; }
